...
int main(int argc, char *argv[])
{
    ...
    HistoryModel history(QStringLiteral("/userdata/industrial_safety/industrial_safety.db"));
    HistoryModel activeHistory(QStringLiteral("/userdata/industrial_safety/industrial_safety.db"), true);
    ...
    engine.rootContext()->setContextProperty(QStringLiteral("activeHistory"), &activeHistory);
